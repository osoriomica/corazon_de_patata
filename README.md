...
| Images                    | Recipe images are displayed properly. If no custom image is available, then a default placeholder is displayed.                                      | Each recipe displays a related image both in index and in the reipe detail page. It allows me to picture the recipe and differentiate it from the rest of the available recipes in the site. Where there's no related recipe image, a placeholder is added by default keeping in line with the site's logo, concept and colours. | Pass         |
| Header:                   |                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                  |              |
...
| Cards                     | On hover over a recipe section, the element transposes                                                                                               | When I hover over the instructions or the method inside a recipe, the container transposes slighthy giving a nicer user experience.                                                                                                                                                                                              | Pass         |
| Star rating               | Rating stars reflect the user's choice on hovering                                                                                                   | When I hover over the stars to give a rating, they are visually affected to show me how many stars are being selected.                                                                                                                                                                                                           | Pass         |
| Next and Previous buttons | Next and previous buttons at bottom of index.html allow users to see the next set of recipe posts from the collection.                               | If I click on next, the index display the next page with recipe cards and the button Previous is now displayed allowing me to go back to the previous page.                                                                                                                                                                      | Pass         |
| User status display       | A message on top of the website informs the user whether they are logged in or not. It also displays the user's username within the welcome message. | As an anonymous user, the top message reminds me I am not logged in, the same for the comments form and the star rating form; which are disabled and invte me to log in to leave a comment or a rating.                                                                                                                          | Pass         |
| Authentication:           |                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                  |              |
| Register                  | Click on the Register link to create a new account that is stored in the website                                                                     | As a new user, I can create a new account that allows me to comment and rate the recipes by clicking on Register and filling out the form.                                                                                                                                                                                       | Pass         |
| Login                     | Click on the Login link so that registered user can use their login details to access the website                                                    | As a registered user, I can log back in to the website by using the Login button in the main navigation.                                                                                                                                                                                                                         | Pass         |
| Logout                    | Click on the Logout link so that logged users can log out from the website                                                                           | As a logged in user, I can click on Logout so that I can log out from my account on the website                                                                                                                                                                                                                                  | Pass         |
| Add Comment               | Logged-in users can leave comments using the form at the bottom of any recipe detail page                                                            | As a logged in user, I can submit a comment to any recipe in the website.                                                                                                                                                                                                                                                        | Pass         |
| Update Comment            | Logged-in users can Update their old comments using the Update button at the bottom of their comments.                                               | As a logged in user, I can choose a comment of my own and edit it by clicking the update and save buttons of the form.                                                                                                                                                                                                           | Pass         |
| Delete Comment            | Logged-in users can delete their old comments using the delete button at the bottom of their comments.                                               | As a logged in user, I can delete a comment of my own by clicking the delete button under my comments.                                                                                                                                                                                                                           | Pass         |
| Comment Monitoring        | Admin must approve a comment before it's public to avoid innapropiate comments.                                                                      | As a logged in user, I can leave a comment, edit it and delete it but the admin must approve it before it appears to other users. The site displays a message letting me know my comment is awaiting moderation.                                                                                                                 | Pass         |
| Star rating               | Give a star rating and update the recipe's rating                                                                                                    | Click on a recipe post. As a logged in user, I can click the stars and submit my rating for a recipe. The rating is immediately updated.                                                                                                                                                                                         | Pass         |
| View recipe details       | Navigate from index to individual recipes.                                                                                                           | From Home, I can click on any of the recipe cards and open a detailed page with the full ingredients and instructions.                                                                                                                                                                                                           | Pass         |
| 404: Go back home         | Click button                                                                                                                                         | Returns to homepage                                                                                                                                                                                                                                                                                                              | Pass         |
| Footer:                   |                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                  |              |
| Styling                   | Fixed to bottom                                                                                                                                      | The footer stays fixed to the bottom of the website and is clearly differentiated fromthe rest of the website.                                                                                                                                                                                                                   | Pass         |
| Errors:                   |                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                  |              |
| Errors page               | Website redirects user to client-side and server error custom pages for 400, 403, 404 405 and 500 errors                                             | If the user enters a wrong url or was to encounter a server error, the website redirects correctly to custom error pages showing the code and a little explanation of the encountered error.                                                                                                                                     | Pass         |
